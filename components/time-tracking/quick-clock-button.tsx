...
export function QuickClockButton({
  ...
  return (
    <button
      onClick={openDrawer}
      className={cn(
        "group flex items-center gap-2 rounded-xl bg-linear-to-r from-primary to-violet-600 px-4 py-2.5 text-sm font-semibold text-white shadow-lg shadow-primary/25 hover:shadow-primary/40 active:scale-[0.98] transition-all duration-300",
        className,
      )}
    >
